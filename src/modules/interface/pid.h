 ...
 * For 5th Deep Drone
 */
#define REDUCE_SF_RATIO     0.7

#define PID_ROLL_RATE_KP  250.0 * REDUCE_SF_RATIO
#define PID_ROLL_RATE_KI  700.0 * REDUCE_SF_RATIO
#define PID_ROLL_RATE_KD  2.8 * REDUCE_SF_RATIO
#define PID_ROLL_RATE_INTEGRATION_LIMIT    33.3

#define PID_PITCH_RATE_KP  250.0 * REDUCE_SF_RATIO
#define PID_PITCH_RATE_KI  700.0 * REDUCE_SF_RATIO
#define PID_PITCH_RATE_KD  2.8 * REDUCE_SF_RATIO
#define PID_PITCH_RATE_INTEGRATION_LIMIT   33.3

#define PID_YAW_RATE_KP  120.0 * REDUCE_SF_RATIO
#define PID_YAW_RATE_KI  16.7 * REDUCE_SF_RATIO
#define PID_YAW_RATE_KD  0.0 * REDUCE_SF_RATIO
#define PID_YAW_RATE_INTEGRATION_LIMIT     166.7

#define PID_ROLL_KP  6.0 * REDUCE_SF_RATIO
#define PID_ROLL_KI  5.0 * REDUCE_SF_RATIO
#define PID_ROLL_KD  0.0 * REDUCE_SF_RATIO
#define PID_ROLL_INTEGRATION_LIMIT    20.0

#define PID_PITCH_KP  6.0 * REDUCE_SF_RATIO
#define PID_PITCH_KI  5.0 * REDUCE_SF_RATIO
#define PID_PITCH_KD  0.0 * REDUCE_SF_RATIO
#define PID_PITCH_INTEGRATION_LIMIT   20.0

#define PID_YAW_KP  6.0 * REDUCE_SF_RATIO
#define PID_YAW_KI  1.0 * REDUCE_SF_RATIO
#define PID_YAW_KD  0.35 * REDUCE_SF_RATIO
#define PID_YAW_INTEGRATION_LIMIT     360.0
...
//#define PID_ROLL_RATE_KP  250.0 * REDUCE_SF_RATIO
//#define PID_ROLL_RATE_KI  500.0 * REDUCE_SF_RATIO
//#define PID_ROLL_RATE_KD  2.5 * REDUCE_SF_RATIO
//#define PID_ROLL_RATE_INTEGRATION_LIMIT    33.3
//
//#define PID_PITCH_RATE_KP  250.0 * REDUCE_SF_RATIO
//#define PID_PITCH_RATE_KI  500.0 * REDUCE_SF_RATIO
//#define PID_PITCH_RATE_KD  2.5 * REDUCE_SF_RATIO
//#define PID_PITCH_RATE_INTEGRATION_LIMIT   33.3
//
//#define PID_YAW_RATE_KP  120.0 * REDUCE_SF_RATIO
//#define PID_YAW_RATE_KI  16.7 * REDUCE_SF_RATIO
...
//
//#define PID_ROLL_KP  6.0 * REDUCE_SF_RATIO
//#define PID_ROLL_KI  3.0 * REDUCE_SF_RATIO
//#define PID_ROLL_KD  0.0 * REDUCE_SF_RATIO
//#define PID_ROLL_INTEGRATION_LIMIT    20.0
//
//#define PID_PITCH_KP  6.0 * REDUCE_SF_RATIO
//#define PID_PITCH_KI  3.0 * REDUCE_SF_RATIO
//#define PID_PITCH_KD  0.0 * REDUCE_SF_RATIO
//#define PID_PITCH_INTEGRATION_LIMIT   20.0
//
//#define PID_YAW_KP  6.0 * REDUCE_SF_RATIO
